...
<!-- repo-links:start -->
1. [5-Mins](https://github.com/charles2ke/5-Mins) — Sends people an early alert in the minutes before a disaster reaches them, so they can act while it still matters.<br>
...
2. [Advantage](https://github.com/charles2ke/Advantage) — Brings insurance shopping, policies and claims into a single platform instead of scattered portals.<br>
...
3. [aero](https://github.com/charles2ke/aero) — Working notes and experiments that turn aerospace engineering theory into runnable examples.<br>
...
4. [Agent-Chaos-Monkey](https://github.com/charles2ke/Agent-Chaos-Monkey) — Injects realistic failures into AI agents — broken connectors, expired auth, prompt injection, schema drift, truncated payloads — and judges from tool-boundary evidence whether the agent reported the truth.<br>
...
5. [baby-model](https://github.com/charles2ke/baby-model) — A model trained only on your own data, so answers stay grounded in what you actually gave it.<br>
...
6. [basa](https://github.com/charles2ke/basa) — A shared dashboard that keeps a family's elder-care circle coordinated around one plan.<br>
...
7. [crabs](https://github.com/charles2ke/crabs) — Makes open agent access safer by putting security controls around Open Claw.<br>
...
8. [design-patterns](https://github.com/charles2ke/design-patterns) — A practical catalogue of the design patterns engineers meet most often, with runnable examples.<br>
...
9. [GitDb](https://github.com/charles2ke/GitDb) — Uses a Git repository as the database, so data gets versioning, history and review for free.<br>
...
10. [GraphQL](https://github.com/charles2ke/GraphQL) — Puts a GraphQL layer in front of any microservice so clients can ask for exactly the data they need.<br>
...
11. [jarvis](https://github.com/charles2ke/jarvis) — A personal AI companion that keeps context across everyday tasks and conversations.<br>
...
12. [legacy](https://github.com/charles2ke/legacy) — A community digital legacy archive preserving people's stories, memories, and contributions, with a simple website and consent-first contribution guidelines.<br>
...
13. [Message-Flow](https://github.com/charles2ke/Message-Flow) — A small, dependency-free Chain of Responsibility library for decoupling message handling.<br>
...
14. [Nakshatra](https://github.com/charles2ke/Nakshatra) — An online shopping portal covering browsing, cart and checkout end to end.<br>
...
15. [Night-Sky](https://github.com/charles2ke/Night-Sky) — Reconstructs the night sky for any date and location in a consistent panoramic style.<br>
...
17. [platform-shared](https://github.com/charles2ke/platform-shared) — Shared auth, profile and notification services reused by social, travel, workout and basa.<br>
...
18. [Portfolio-Watcher](https://github.com/charles2ke/Portfolio-Watcher) — Gathers every financial account into one place so the whole portfolio is visible at a glance — the watchlist and alerting companion to OpenTrading.<br>
...
19. [social](https://github.com/charles2ke/social) — A social media manager for planning and coordinating posts across audiences.<br>
...
20. [tax-break](https://github.com/charles2ke/tax-break) — An online estimator that makes individual income tax easier to understand before filing.<br>
...
21. [tito](https://github.com/charles2ke/tito) — Keeps a team in sync on when everyone is in and when everyone is out — together in, together out.<br>
...
22. [TitoOS](https://github.com/charles2ke/TitoOS) — An operating system for agents: a runtime purpose-built for running and supervising them.<br>
...
23. [travel](https://github.com/charles2ke/travel) — A place to explore, dream and discover trips worth taking.<br>
...
24. [workout](https://github.com/charles2ke/workout) — A weekly workout plan that makes training consistent and easy to follow.<br>
...
25. [X-Big-Brother](https://github.com/charles2ke/X-Big-Brother) — Shows how your data, Wi-Fi and mobile network watch you, and hands control back to you.<br>
